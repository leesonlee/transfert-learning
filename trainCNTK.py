...
train_image_folder = os.path.join(base_folder, "..", "..", "..", "data", "Keras-transfert-learning", "train")
test_image_folder = os.path.join(base_folder, "..", "..", "..", "data", "Keras-transfert-learning", "test")
